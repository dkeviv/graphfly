...
test('neighborhood returns focused nodes/edges and occurrence counts', async () => {
  ...
  const out = await neighborhood({ store, tenantId: t, repoId: r, symbolUid: 'A', direction: 'out' });
