...
| `FR-CIG-11` — No Code Exposure in UI/Support Mode | `docs/02_REQUIREMENTS.md:147` | ✅ | BLOCKER | `docs/03_TECHNICAL_SPEC.md`, `docs/01_ARCHITECTURE.md`, `docs/03_TECHNICAL_SPEC.md` + `docs/07_ADMIN_GUIDE.md`, `docs/05_SECURITY.md`, workers/indexer/, packages/cig/, packages/ndjson/, packages/cig-pg/, migrations/001_init.sql |
